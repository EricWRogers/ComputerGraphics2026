...
void GhostStart(AppContext* _app, Entity* _entity) {}

void GhostUpdate(AppContext* _app, Entity* _entity)
{
    ENTITY_DATA(Ghost, ghostData, _entity);
}

void GhostDraw(AppContext* _app, Entity* _entity)
{
    ENTITY_DATA(Ghost, ghostData, _entity);
...
void GhostOnDestroy(AppContext* _app, Entity* _entity) {}
